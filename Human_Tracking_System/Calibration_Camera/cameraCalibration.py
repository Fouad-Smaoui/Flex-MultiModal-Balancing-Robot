...
workingFolder   = "C:\\Users\matri\OneDrive\Documents\M2\PFE\Image processing\Calibration Camera"
imageType       = 'jpg'
#------------------------------------------
...
filename    = workingFolder + "\imageChess" + "/*." + imageType
...
if (nPatternFound > 1):
    ...
    cv2.imwrite(workingFolder +"/intrinsicParam"+ "/calibresult.png",dst)
    ...
    #--------- Save result
    filename = workingFolder +"/intrinsicParam"+ "/cameraMatrix.txt"
    np.savetxt(filename, mtx, delimiter=',')
    filename = workingFolder +"/intrinsicParam"+ "/cameraDistortion.txt"
